...
var VueColorKit = (function (exports, vue) {
  ...
  const _hoisted_1$3 = /*#__PURE__*/ vue.createVNode(
    'path',
    {
      d:
  ...
  function render$5(_ctx, _cache, $props, $setup, $data, $options) {
    return (
      vue.openBlock(),
      vue.createBlock('div', _hoisted_1$4, [
        vue.createVNode(
          'span',
          _hoisted_2,
        ...
        vue.withDirectives(
          vue.createVNode(
            'input',
            {
              'onUpdate:modelValue':
                _cache[1] ||
                (_cache[1] = ($event) => (_ctx.modelColor = $event)),
              class: 'value',
            },
            null,
            512 /* NEED_PATCH */
      ...
      vue.createBlock('div', null, [
        vue.createVNode('ul', _hoisted_1$5, [
          ...
          vue.createBlock(
            vue.Fragment,
            null,
            vue.renderList(_ctx.colorsDefault, (item) => {
              return (
                vue.openBlock(),
                vue.createBlock(
                  'li',
        ...
        _ctx.colorsHistory.length
          ? (vue.openBlock(),
            vue.createBlock('ul', _hoisted_2$1, [
              (vue.openBlock(true),
              vue.createBlock(
                vue.Fragment,
                null,
                vue.renderList(_ctx.colorsHistory, (item) => {
                  return (
                    vue.openBlock(),
                    vue.createBlock(
                      'li',
                      ...
                      [
                        vue.createVNode(
                          ...
                          {
                            style: {
                              background: `url(${_ctx.imgAlphaBase64})`,
                            },
                            class: 'alpha',
                          },
                          null,
